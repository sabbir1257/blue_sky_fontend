...
const GetQuotes = () => {
    return (
        <div className="relative w-full h-[350px] mb-20 parallax"
        style={{
        ...
        >
            <div className="absolute top-0 w-full h-full text-white bg-[#000000b2]">
                <Container className="text-center flex flex-col items-center w-full h-full justify-center gap-8">
                    <h1 className="lg:text-5xl text-2xl font-medium text-gray-200">We provide high quality services & innovative<br />solutions for the realiable growth</h1>
