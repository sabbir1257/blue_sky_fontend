...
const BottomFooter = () => {
  return (
    <section className="py-2 bg-blue-950 text-gray-300">
      <Container className="flex lg:flex-row flex-col justify-between items-center" >
        <p className="lg:font-medium font-semibold tracking-wider lg:w-[40%] ">Copyright © 2025 All rights reserved | This template is made with  by <a href="https://paradisesolution.us/" target="_blank" className="text-purple-800 font-bold cursor-pointer">Paradise Solution</a></p>
